...
//         to: email,
//         subject: "You're on the Crane Core waitlist 🚀",
//         html: `
//           <div style="font-family: Arial, sans-serif; padding: 20px;">
//             <h2>Welcome to Crane Core Group</h2>
//             <p>Hi ${firstName},</p>
//             <p>You're officially on the waitlist.</p>
//             <p>We’re building AI systems for construction workflows.</p>
//             <p>You’ll be among the first to get access.</p>
//             <br/>
//             <p>— Crane Core Group</p>
//           </div>
//         `,
//       });
